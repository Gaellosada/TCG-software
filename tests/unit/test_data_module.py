...
# construction + MongoInstrumentReader patching) were removed in the
# MongoDB->dwh SQL cutover. The service is now PostgreSQL-backed; its
# behaviour is verified against live dwh by output/parity_harness.py and
# by tests/unit/data/sql/test_sql_helpers.py (pure gotcha/Decimal logic).
# ===================================================================
